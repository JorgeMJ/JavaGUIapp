...
public class InputFacultyFormController implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {        
        // TO-DO
        // Determine what the event is and call the correct method for the event
